...
<head>
  ...
  .jumbotron {
    position: relative;
    background: #000 url("http://embassysuites3.hilton.com/resources/media/es/SFOSOES/en_US/img/shared/full_page_image_gallery/main/ES_downtown01_25_712x342_FitToBoxSmallDimension_Center.jpg") center center;
    width: 100%;
    height: 100%;
...
<nav class="navbar navbar-default navbar-fixed-top">
 ...
 <div class="jumbotron text-center">
  <h1>Places</h1>
  <p>Search Places near you</p>
  <form class="form-inline" method="POST" action="searchplacesReq">
 ...
 <div id="tour" class="bg-1">
  <div class="container">
    <h3 class="text-center">Places For Location</h3>
    
    <c:set var="count" value="1" scope="page"/>
    <c:forEach var="items" items="${listOfplaces}">
      ...
      <div class="col-sm-4">
        ...
        <div class="thumbnail">
          <img src="${items.imageURL}" alt="No Image" style=" height: 230Px;" width="400" >
          <p><strong>${items.name}</strong></p>
          <p>${items.displayadd1 }
          <br>${items.displayadd2 }</p><br>
          <img src="${items.ratingImgUrlLarge}" alt="No Rating" style="height: 27Px;width: 140px;">
          <p>Reviews : ${items.reviewCount}</p>
           <form action="${pageContext.request.contextPath}/searchplacesByIDReq?eventID=${items.yelpid}" method="Post">
