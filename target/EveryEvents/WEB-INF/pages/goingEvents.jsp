         ...
         <table class="table">
                    <tbody>
                      <tr>
                          ...
                          <td><b>State</b></td>
                          <td><b>Rating</b></td>
                          <td><b>Open Event</b></td>
                      </tr>
                      <c:forEach var="items" items="${userEvents}">
                            <tr>
                                    <td>${items.name}</td>
                                    <td>${items.starttime}</td>
                                    <td>${items.venue.city}</td>
                                    <td>${items.venue.state}</td>
                                    <td>${items.rating}</td>
                                    <td>
                                    
                                     <div class="btn-group" role="group" aria-label="Open Event">
		                          		<table>
		                          		<tr>
		                          		<td>
		                          		<c:if test="${items.source eq 'meetup'}">
		                          		...
		                          		<c:if test="${items.source eq 'eventbrite'}">
