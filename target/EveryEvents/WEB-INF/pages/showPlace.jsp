    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <div class="card-background">
            <img class="card-bkimg" alt="" src="${yelpPlace.imageURL}">
        
        </div>
        <div class="useravatar">
            <img alt="" src="${yelpPlace.imageURL}">
            <br><span class="card-title">${yelpPlace.name}</span>
        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="col-sm-2" >
					   ...
					   <div class="thumbnail text-center">
				          <img src="${yelpPlace.imageURL}" alt="Paris" style=" height: 140Px;" width="400" height="300">
				            <p style="color: #d9534f;"><b>Group</b></p>
				          <p> ${yelpPlace.name} </p><br>
						  <a href="${yelpPlace.url}" target="_blank" class="btn">See Place</a>
				          <p><a href="${yelpPlace.mobileURL }" target="_blank" class="btn">Mobile</a>
				        </div>
				         <div class="thumbnail text-center">
				             <p style="color: #d9534f;"><b>Rating</b></p>
				            <img src="${yelpPlace.ratingImgUrlLarge}" alt="Rating" style=" height: 25Px;" width="100" height="50">
				       </div>
				      <div class="thumbnail text-center">
                          <p style="color: #d9534f;"><b>Share Place</b></p>
					 ...
					 <div class="thumbnail text-center">
                          <p style="color: #d9534f;"><b>Do You Like Place ?</b></p>
				             <a href="" target="_blank" class="btn"><span class="glyphicon glyphicon-thumbs-up"></span> Yes</a>
            ...
            <div class="col-sm-8" >
                <table class="table table-striped">
                    <tbody>
                      <tr>
                          <td><b>Snippet Message</b></td>
                          <td>${yelpPlace.snippet_text}</td>
                      </tr>
                      <tr>
                          <td><b>Snippet From</b></td>
                          <td>  <img src="${yelpPlace.snippetImgUrl}" alt="Snippet Image" ></td>
                      </tr>
                        <tr>
                          <td><b>Address</b></td>
                          <td>
                          <p> ${yelpPlace.displayadd1} </p>
                          <p> ${yelpPlace.displayadd2} </p>
                          <p> ${yelpPlace.city} </p>
                          <p> ${yelpPlace.state} - ${yelpPlace.postalCode}</p>
                          <p> ${yelpPlace.country} </p>
                          </td>
                      </tr>
                      <tr>
                          <td><b>Phone</b></td>
                          <td>${yelpPlace.displayPhone}</td>
                      </tr>
                       <tr>
                          <td><b>Reviews</b></td>
                          <td>${yelpPlace.reviewCount}</td>
                      </tr>
                    </tbody>
        </table>
        </div>
         <div class="col-sm-2" >
                       <div class="thumbnail text-center">
				          ...
				          <img src="https://s3-media2.fl.yelpcdn.com/assets/srv0/www_pages/95212dafe621/assets/img/brand_guidelines/yelp-2c.png" alt="Paris" style=" height: 121Px;" width="400" height="300">
				          <p> ${yelpPlace.name}</p><br>
						   <a href="${yelpPlace.url}" target="_blank" class="btn">See Place</a>
				       ...
				       <div class="thumbnail text-center">
				          ...
				          <a href="https://www.google.com/maps/preview/@${yelpPlace.lat},${yelpPlace.lon}" target="_blank" class="btn">Maps</a>
				         </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
       ...
       <div class="modal-body">
          <form role="form"  role="form" action="sharePlacesByMail?placeID=${yelpPlace.yelpid}"  method="POST">
...
var lon = eval("${yelpPlace.lon}");
var lat = eval("${yelpPlace.lat}");
