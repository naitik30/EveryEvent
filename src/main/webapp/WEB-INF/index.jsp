  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="#band">EVENTS</a></li>
        <li><a href="#tour">MEETUPS</a></li>
        ...
        <li><a href="#"><span class="glyphicon glyphicon-search"></span></a></li>
     	   <li> <button class="btn" data-toggle="modal" data-target="#myModal">LOG IN</button></li>
     	   <li> <button class="btn" data-toggle="modal" data-target="#myModal">SIGN UP</button></li>
      </ul>
    </div>
  </div>
</nav>
