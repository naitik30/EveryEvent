        ...
        <div class="container-fluid">
         ...
         <table class="table">
                    <tbody>
                      ...
                      <c:forEach var="items" items="${listusers}">
                            <tr>
                                    ...
                                    <td>
                                     ...
                                     <div class="btn-group" role="group" aria-label="Password operations">
		                          		<table>
		                          		<tr>
		                          		<td> <form action="${pageContext.request.contextPath}/deleteUserReq?email=${items.email}" method="Post">
		                          		 	<input type="submit" class="btn btn-info" id="submit" value="Delete User" > 
		                          		 </form></td>
		                          		<td> 
		                          		    <form action="${pageContext.request.contextPath}/showUserReq?email=${items.email}" method="Post">
		                          		 	<input type="submit" class="btn btn-info" id="submit" value="Show User" > 
		                          		 </form>
		                          		 </td>
		                          		</tr>
		                          		</table>
