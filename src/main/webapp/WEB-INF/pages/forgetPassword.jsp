...
<nav class="navbar navbar-default navbar-fixed-top">
  ...
  <h2>EveryEvents</h2>
  <p>Forgot Password ? Dont Worry.</p>
</div>
        <br>
            ...
            <div class="col-sm-6" >
                        ...
                        <div class="panel panel-default">
                          ...
                          <div id="forgotPwd" class="panel-collapse">
									...
									<form name="forgetForm" role="form" method="POST"
									...
									<c:if test="${Error == 1}">
										<div class="alert alert-danger">
											<strong>Error! </strong>Email Or No user is available!!
										</div>
									</c:if>
									<c:if test="${Error == 0}">
										<div class="alert alert-success">We just sent you new password. Check your email.</div>
									</c:if>
								</div>
                          </div>
                        </div>
