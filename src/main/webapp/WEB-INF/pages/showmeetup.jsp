    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <div class="card-background">
            <img class="card-bkimg" alt="" src="${meetupEvent.logoURL}">
        
        </div>
        <div class="useravatar">
            <img alt="" src="${meetupEvent.logoURL}">
            <br><span class="card-title">${meetupEvent.name}</span>
        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="col-sm-2" >
					   ...
					   <div class="thumbnail text-center">
				          <img src="${meetupEvent.logoURL}" alt="Paris" style=" height: 182Px;" width="400" height="300">
				            <p style="color: #d9534f;"><b>Group</b></p>
				          <p> ${meetupEvent.eventGroup.name} </p><br>
						  <a href="http://www.meetup.com/${meetupEvent.eventGroup.groupUrl}" target="_blank" class="btn">See Group</a>
				          <p><a href="${meetupEvent.event_url}" target="_blank" class="btn">See Event</a>
				        </div>
				         <div class="thumbnail text-center">
				             <p style="color: #d9534f;"><b>Rating</b></p>
				           <c:if test="${meetupEvent.rating==0}">
				           ...
				           <c:if test="${meetupEvent.rating==0.5}">
				           ...
				           <c:if test="${meetupEvent.rating==1.0}">
				           ...
				           <c:if test="${meetupEvent.rating==1.5}">
				           ...
				           <c:if test="${meetupEvent.rating==2.0}">
				           ...
				           <c:if test="${meetupEvent.rating==2.5}">
				           ...
				           <c:if test="${meetupEvent.rating==3.0}">
				           ...
				           <c:if test="${meetupEvent.rating==3.5}">
				           ...
				           <c:if test="${meetupEvent.rating==4.0}">
				           ...
				           <c:if test="${meetupEvent.rating==4.5}">
				           ...
				           <c:if test="${meetupEvent.rating==5.0}">
				       ...
				       <div class="thumbnail text-center">
                          <p style="color: #d9534f;"><b>Going in Event?</b></p>
				             <a href="${pageContext.request.contextPath}/visitMeetupsYesByIDReq?eventID=${meetupEvent.event_id}" class="btn"><span class="glyphicon glyphicon-thumbs-up"></span> Yes</a>
            ...
            <div class="col-sm-8" >
                <table class="table table-striped">
                    <tbody>
                      <tr>
                          <td><b>Duration</b></td>
                          <td>${meetupEvent.duration}</td>
                      </tr>
                     <c:if test="${meetupEvent.endtime==NULL}">
              			<tr>
                          <td><b>Time</b></td>
                          <td>${meetupEvent.starttime}</td>
                        </tr>
                       </c:if>
                    ...
                    <c:if test="${meetupEvent.endtime!=NULL}">
                      ...
                      <tr>
                        ...
                        <tr>
                          ...
                          <td>${meetupEvent.description}</td>
                      </tr>
                        <tr>
                          <td><b>Vanue</b></td>
                          <td>
                          <p> ${meetupEvent.venue.name} </p>
                          <p> ${meetupEvent.venue.address1} </p>
                          <p> ${meetupEvent.venue.address2} </p>
                          <p> ${meetupEvent.venue.address3} </p>
                          <p> ${meetupEvent.venue.city} </p>
                          <p> ${meetupEvent.venue.state} </p>
                          <p> ${meetupEvent.venue.country} </p>
                          <p> ${meetupEvent.venue.zip} </p>
                          <p> ${meetupEvent.venue.phone} </p>
                          </td>
                      </tr>
                      <tr>
                          <td><b>Amount Fees</b></td>
                          <td>${meetupEvent.amount} $</td>
                      </tr>
                        <tr>
                          <td><b>Why</b></td>
                          <td>${meetupEvent.why}</td>
                      </tr>
                        <tr>
                          <td><b>Capacity</b></td>
                          <td>${meetupEvent.capacity}</td>
                      </tr>
                        <tr>
                          <td><b>Head Count</b></td>
                          <td>${meetupEvent.headCount}</td>
                      </tr>
                        <tr>
                          <td><b>Yes Count</b></td>
                          <td>${meetupEvent.yesCount}</td>
                      </tr>
                        <tr>
                          <td><b>Rsvp Limit</b></td>
                          <td>${meetupEvent.rsvpLimit}</td>
                      </tr>
                      
                      <tr>
                          <td><b>Waitlist Count</b></td>
                          <td>${meetupEvent.waitlistCount}</td>
                      </tr>
                      <tr>
                          <td><b>Yes Rsvp Count</b></td>
                          <td>${meetupEvent.yesRsvpCount}</td>
                      </tr>
                      <tr>
                          <td><b>is Reserved Seating</b></td>
                          <td>${meetupEvent.isReservedSeating}</td>
                      </tr>
                      <tr>
                          <td><b>May Be Rsvp Count</b></td>
                          <td>${meetupEvent.maybeRsvpCount}</td>
                      </tr>
                      <tr>
                       <td><b>Status</b></td>
                          <td>${meetupEvent.status}</td>
                      </tr>
                      <tr>
                       <td><b>Created On</b></td>
                          <td>${meetupEvent.created}</td>
                      </tr>
                      <tr>
                       <td><b>Last Updated</b></td>
                          <td>${meetupEvent.updated}</td>
                      </tr>
                    </tbody>
        </table>
        </div>
         <div class="col-sm-2" >
                       <div class="thumbnail text-center">
				          <img src="http://www.ranklogos.com/wp-content/uploads/2012/04/meetup_logo.png" alt="Paris" style=" height: 121Px;" width="400" height="300">
				            <p style="color: #d9534f;"><b>Brought to you by</b></p>
				          <p> ${meetupEvent.name}</p><br>
						  <p><a href="${meetupEvent.event_url}" target="_blank" class="btn">See Event</a>
				          </p>
				        ...
				        <div class="thumbnail text-center">
				         <p style="    color: #d9534f;"><b>Hotel near Vanue</b></p>
				          <p><a href="${pageContext.request.contextPath}/placesHotelNearReq?city=${meetupEvent.venue.city}&state=${meetupEvent.venue.state}" target="_blank" class="btn">Hotels</a>
				          </p>
				        </div>
				        <div class="thumbnail text-center">
				          <p style="    color: #d9534f;"><b>Restaurant near Vanue</b></p>
				          <p><a href="${pageContext.request.contextPath}/placesRestaurantNearReq?city=${meetupEvent.venue.city}&state=${meetupEvent.venue.state}" target="_blank" class="btn">Restaurant</a>
				          </p>
				        </div>
				        <div class="thumbnail text-center">
                          <p style="color: #d9534f;"><b>See In Maps</b></p>
				          <a href="https://www.google.com/maps/@${meetupEvent.venue.lat},${meetupEvent.venue.lon}" target="_blank" class="btn">Maps</a>
				         </div>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-header" style="background-color: #f44336;">
					...
					<h5>
						<span class="glyphicon glyphicon-lock"></span>Share The Event
					</h5>
				</div>
				<div class="modal-body">
					<form role="form" role="form"
						action="shareMeetupByMail?eventID=${meetupEvent.event_id}"
						method="POST">
						...
						<button type="submit"
							style="background-color: #f44336; border-radius: 4Px; border-color: #f44336;"
							name="submit" id="submit" class="btn btn-success">Share</button>
					</form>
				</div>
...
var lon = eval("${meetupEvent.venue.lon} ");
var lat = eval("${meetupEvent.venue.lat} ");
